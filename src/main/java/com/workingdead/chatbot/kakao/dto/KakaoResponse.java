...
//         private Map<String, Map<String, String>> mentions;
//     }
...
//         String text,
//         Map<String, Map<String, String>> mentions,
...
//                     ))
//                     .quickReplies(quickReplies)
//                     .extra((mentions == null || mentions.isEmpty()) ? null : 
//                             Extra.builder().mentions(mentions).build())  // ← template 안으로
//                     .build())
//             .build();  // ← 최상위 .extra() 제거
//     }
